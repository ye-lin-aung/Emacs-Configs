...
(define-abbrev-table 'eaf-mode-abbrev-table '())
...
(define-abbrev-table 'ember-build-mode-abbrev-table '())

(define-abbrev-table 'ember-serve-mode-abbrev-table '())

(define-abbrev-table 'ember-test-mode-abbrev-table '())
